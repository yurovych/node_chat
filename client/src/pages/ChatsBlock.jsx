...
export const ChatBlock = () => {
  ...
  return (
    <div className='w-full flex flex-col'>
            ...
            {({ touched, errors, isSubmitting, resetForm, values }) => (
              <Form className='flex items-center h-8'>
                <div className='h-full'>
                  ...
                  {touched.newChatName &&
                    errors.newChatName &&
                    setAnyError(errors.newChatName)}
                </div>
      ...
      <div className='border-solid w-full h-70vh p-3 overflow-y-scroll'>
        {allChats.map((chat) => {
          return (
            <div
              key={chat.id}
                    ...
                    {({ touched, errors, isSubmitting, resetForm, values }) => (
                      <Form className='flex items-center h-8'>
                        <div className='relative'>
                          <div>
                            <Field
                              className='h-full rounded-xl p-2 w-40'
                              validate={chatNameValidation}
                              name='renameValue'
                              type='text'
                              id='renameValue'
                          ...
                          {touched.renameValue &&
                            errors.renameValue &&
                            setAnyError(errors.renameValue)}
                        </div>
